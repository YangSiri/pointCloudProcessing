...
#ifndef POINTCLOUDPROCESSING_PCAPREADER_H
#define POINTCLOUDPROCESSING_PCAPREADER_H
 ...
 * Packet数据：即 Packet（通常就是链路层的数据帧）具体内容，长度就是Caplen，这个长度的后面，
 ...
 *            下一组数据在文件中的起始位置。我们需要靠第一个Packet包确定。 */
    ...
    int readpcapfile(char *filepath);
};

#endif //POINTCLOUDPROCESSING_PCAPREADER_H
